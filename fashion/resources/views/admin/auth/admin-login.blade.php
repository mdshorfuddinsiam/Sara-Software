...
<head>
  <meta charset="utf-8">
    ...
    <title>Unique Fashion - Log in </title>
                            ...
                            <form method="POST" action="{{ route('admin.login') }}">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="email" id="email" class="form-control pl-15 bg-transparent text-white plc-white" name="email" value="{{ old('email') }}" placeholder="Email" required autocomplete="email" autofocus >
                                        @error('email')
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password" id="password" class="form-control pl-15 bg-transparent text-white plc-white" name="password" placeholder="Password" required autocomplete="current-password" >
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
