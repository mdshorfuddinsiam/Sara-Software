          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                <li class="active dropdown yamm-fw"> <a href="{{ url('/') }}" data-hover="dropdown">Home</a> </li>
                @foreach($categories as $row)
                <li class="dropdown yamm mega-menu"> <a href="{{ route('categorywise.product', ['category' => @$row->id]) }}" data-hover="dropdown">{{ @$row->category_name }}</a>
                </li>
                @endforeach
